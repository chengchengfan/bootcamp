...
# Data concatenations
df_all_dd = pd.concat((df_1973_dd, df_1975_dd, df_1987_dd, df_1991_dd, df_2012_dd), axis=0, ignore_index=True)
...
#
# plt.plot(x_1987_blf, y_1987_blf, marker='.', linestyle='none', markersize=7, alpha=0.5, color='red')
# plt.plot(x_1987_bls, y_1987_bls, marker='.', linestyle='none', markersize=7, alpha=0.5, color='orange')
#
